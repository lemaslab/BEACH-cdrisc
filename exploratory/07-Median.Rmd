...
# [X] mom3t_folic
data_sss=data_sss%>%
  mutate(mom3t_folic=recode_factor(mom3t_folic,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
...
# [X] mom3t_healthy_wt
data_sss=data_sss%>%
  mutate(mom3t_healthy_wt=recode_factor(mom3t_healthy_wt,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
...
# [X] mom3t_vaccine
data_sss=data_sss%>%
  mutate(mom3t_vaccine=recode_factor(mom3t_vaccine,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_dentist
data_sss=data_sss%>%
  mutate(mom3t_dentist=recode_factor(mom3t_dentist,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_genetics
data_sss=data_sss%>%
  mutate(mom3t_genetics=recode_factor(mom3t_genetics,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_medical_ctrl
data_sss=data_sss%>%
  mutate(mom3t_medical_ctrl=recode_factor(mom3t_medical_ctrl,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
...
# [X] mom3t_depression2
data_sss=data_sss%>%
  mutate(mom3t_depression2=recode_factor(mom3t_depression2,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_infertility
data_sss=data_sss%>%
  mutate(mom3t_infertility=recode_factor(mom3t_infertility,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_rx_safety
data_sss=data_sss%>%
  mutate(mom3t_rx_safety=recode_factor(mom3t_rx_safety,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_smoke
data_sss=data_sss%>%
  mutate(mom3t_smoke=recode_factor(mom3t_smoke,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_alcohol	
data_sss=data_sss%>%
  mutate(mom3t_alcohol=recode_factor(mom3t_alcohol,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
# [X] mom3t_drugs
data_sss=data_sss%>%
  mutate(mom3t_drugs=recode_factor(mom3t_drugs,
                                        "1" = "Yes ",
                                        "2" = "No ",
                                        "3" = "Not applicable"
                                        ))
...
sss_america_vars=c("test_id", "subsoc_where_america", "mom3t_folic", "mom3t_healthy_wt", "mom3t_vaccine", "mom3t_dentist", "mom3t_genetics", "mom3t_medical_ctrl", "mom3t_depression2", "mom3t_infertility", "mom3t_rx_safety", "mom3t_smoke", "mom3t_alcohol", "mom3t_drugs")

sss_community_vars=c("test_id", "subsoc_where_community", "mom3t_folic", "mom3t_healthy_wt", "mom3t_vaccine", "mom3t_dentist", "mom3t_genetics", "mom3t_medical_ctrl", "mom3t_depression2", "mom3t_infertility", "mom3t_rx_safety", "mom3t_smoke", "mom3t_alcohol", "mom3t_drugs")
...
var_label(dat_label) <- list(mom3t_folic = "Taking vitamins with folic acid before pregnancy",
                             mom3t_healthy_wt = "Being a healthy weight before pregnancy",
                             mom3t_vaccine = "Getting my vaccines updated before pregnancy",
                             mom3t_dentist = "Visiting a dentist or dental hygienist before pregnancy",
                             mom3t_genetics = "Getting counseling for any genetic diseases that run in the family",
                             mom3t_medical_ctrl = "Controlling any medical conditions such as diabetes and high blood pressure",
                             mom3t_depression2 = "Getting counseling or treatment for depression or anxiety",
                             mom3t_infertility = "Getting counseling or treatment for infertility",
                             mom3t_rx_safety = "The safety of using prescription/over-the-counter medicines during pregnancy",
                             mom3t_smoke = "How smoking during pregnancy can affect a baby",
                             mom3t_alcohol = "How drinking alcohol during pregnancy can affect a baby",
                             mom3t_drugs = "How using illegal drugs during pregnancy can affect a baby"
                              )
```
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 01 - American Society SSS Effect on Healthcare Resources")
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 02 - Community SSS Effect on Healthcare Resources")
