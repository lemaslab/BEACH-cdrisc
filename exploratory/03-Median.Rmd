...
# [X] mom3t_asthma_3mo
data_sss=data_sss%>%
  mutate(mom3t_asthma_3mo=recode_factor(mom3t_asthma_3mo,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
# [X] mom3t_anemia_3mo
data_sss=data_sss%>%
  mutate(mom3t_anemia_3mo=recode_factor(mom3t_anemia_3mo,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
# [X] mom3t_heart_3mo
data_sss=data_sss%>%
  mutate(mom3t_heart_3mo=recode_factor(mom3t_heart_3mo,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_epilepsy_3mo
data_sss=data_sss%>%
  mutate(mom3t_epilepsy_3mo=recode_factor(mom3t_epilepsy_3mo,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_thyroid_3mo
data_sss=data_sss%>%
  mutate(mom3t_thyroid_3mo=recode_factor(mom3t_thyroid_3mo,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_anxiety_3mo
data_sss=data_sss%>%
  mutate(mom3t_anxiety_3mo=recode_factor(mom3t_anxiety_3mo,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
sss_america_vars=c("test_id", "subsoc_where_america", "mom3t_asthma_3mo", "mom3t_anemia_3mo", "mom3t_heart_3mo", "mom3t_epilepsy_3mo", "mom3t_thyroid_3mo", "mom3t_anxiety_3mo")

sss_community_vars=c("test_id", "subsoc_where_community", "mom3t_asthma_3mo", "mom3t_anemia_3mo", "mom3t_heart_3mo", "mom3t_epilepsy_3mo", "mom3t_thyroid_3mo", "mom3t_anxiety_3mo")
...
var_label(dat_label) <- list(mom3t_asthma_3mo = "Asthma",
                             mom3t_anemia_3mo = "Anemia",
                             mom3t_heart_3mo = "Heart Issues",
                             mom3t_epilepsy_3mo = "Epilepsy (Seizures)",
                             mom3t_thyroid_3mo = "Thyroid problems",
                             mom3t_anxiety_3mo = "Anxiety"
                              )
```
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 01 - American Society SSS Effect on Clinical Outcomes")
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 02 - Community SSS Effect on Clinical Outcomes")
