...
# [X] mom3t_diet
data_sss=data_sss%>%
  mutate(mom3t_diet=recode_factor(mom3t_diet,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
# [X] mom3t_exercise
data_sss=data_sss%>%
  mutate(mom3t_exercise=recode_factor(mom3t_exercise,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))

# [X] mom3t_meds_regular
data_sss=data_sss%>%
  mutate(mom3t_meds_regular=recode_factor(mom3t_meds_regular,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_diabetes
data_sss=data_sss%>%
  mutate(mom3t_diabetes=recode_factor(mom3t_diabetes,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_bp
data_sss=data_sss%>%
  mutate(mom3t_bp=recode_factor(mom3t_bp,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_depression
data_sss=data_sss%>%
  mutate(mom3t_depression=recode_factor(mom3t_depression,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
# [X] mom3t_med_hx
data_sss=data_sss%>%
  mutate(mom3t_med_hx=recode_factor(mom3t_med_hx,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_dental
data_sss=data_sss%>%
  mutate(mom3t_dental=recode_factor(mom3t_dental,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
sss_america_vars=c("test_id", "subsoc_where_america", "mom3t_diet", "mom3t_exercise", "mom3t_meds_regular", "mom3t_diabetes", "mom3t_bp", "mom3t_depression", "mom3t_med_hx", "mom3t_dental")

sss_community_vars=c("test_id", "subsoc_where_community", "mom3t_diet", "mom3t_exercise", "mom3t_meds_regular", "mom3t_diabetes", "mom3t_bp", "mom3t_depression", "mom3t_med_hx", "mom3t_dental")
...
var_label(dat_label) <- list(mom3t_diet = "I was dieting (changing my eating habits) to lose weight",
                             mom3t_exercise = "I was exercising 3 or more days of the week",
                             mom3t_meds_regular = "I was regularly taking prescription medicines other than birth control",
                             mom3t_diabetes = "I visited a health care worker and was checked for diabetes",
                             mom3t_bp = "I visited a health care worker and was checked for high blood pressure",
                             mom3t_depression = "I visited a health care worker and was checked for depression or anxiety",
                             mom3t_med_hx = "I talked to a health care worker about my family medical history",
                             mom3t_dental = "I had my teeth cleaned by a dentist or dental hygienist"
                              )
```
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 01 - American Society SSS Effect on Prenatal Care Access")
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 02 - Community SSS Effect on Prenatal Care Access")
