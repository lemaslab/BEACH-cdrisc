---
title: "04-Prenatal Health Conditions"
...
# [X] mom3t_diabetes2
data_sss=data_sss%>%
  mutate(mom3t_diabetes2=recode_factor(mom3t_diabetes2,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
# [X] mom3t_high_bp
data_sss=data_sss%>%
  mutate(mom3t_high_bp=recode_factor(mom3t_high_bp,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
# [X] mom3t_depression3
data_sss=data_sss%>%
  mutate(mom3t_depression3=recode_factor(mom3t_depression3,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_pos
data_sss=data_sss%>%
  mutate(mom3t_pos=recode_factor(mom3t_pos,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_ovarian
data_sss=data_sss%>%
  mutate(mom3t_ovarian=recode_factor(mom3t_ovarian,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
# [X] mom3t_std
data_sss=data_sss%>%
  mutate(mom3t_std=recode_factor(mom3t_std,
                                        "1" = "Yes ",
                                        "2" = "No "
                                        ))
...
sss_america_vars=c("test_id", "subsoc_where_america", "mom3t_diabetes2", "mom3t_high_bp", "mom3t_depression3", "mom3t_pos", "mom3t_ovarian", "mom3t_std")

sss_community_vars=c("test_id", "subsoc_where_community", "mom3t_diabetes2", "mom3t_high_bp", "mom3t_depression3", "mom3t_pos", "mom3t_ovarian", "mom3t_std")
...
var_label(dat_label) <- list(mom3t_diabetes2 = "Type 1 or type 2 diabetes",
                             mom3t_high_bp = "High blood pressure",
                             mom3t_depression3 = "Depression",
                             mom3t_pos = "Polycystic Ovarian Syndrome (POS)",
                             mom3t_ovarian = "Primary ovarian insufficiency, endometriosis, uterine fibroids",
                             mom3t_std = "Sexually transmitted infection"
                              )
```
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 01 - American Society SSS Effect on Prenatal Health Conditions")
...
dat_label %>% 
  ...
  add_overall() %>% add_p(pvalue_fun = function(x)style_pvalue(x,digits = 3)) %>%
    as_gt() %>%
  tab_header(title = "Table 02 - Community SSS Effect on Prenatal Health Conditions")
